        ...
        <main className="relative z-10 mx-auto mt-16 max-w-xl px-4 py-4 text-zinc-900 dark:text-zinc-100">
          <section className="mb-8 flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h1 className="font-gambarino font-medium text-2xl tracking-tight">
                Hi, I'm Dominik Koch
              </h1>
        ...
        <footer className="relative z-50 mt-8">
          <div className="mx-auto flex max-w-xl flex-col items-center gap-2 px-4 py-4 text-center sm:flex-row sm:items-center sm:justify-between sm:gap-0 sm:text-left">
            ...
            <p className="text-sm text-zinc-900 dark:text-muted-foreground">
              Inspired by
              <a
                className="relative font-bold text-black/90 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-left after:scale-x-0 after:bg-zinc-900 after:transition-transform after:duration-300 after:ease-in-out hover:after:scale-x-100 dark:text-zinc-100 dark:after:bg-zinc-100"
